...
import {
    ...
    HStack,
    VStack,
    Heading, useColorModeValue, Badge, Divider, SimpleGrid,
} from 'native-base';
...
const EmpleadoStackScreen = () => {
    ...
    const managementOptions = [
        ...
        {
            title: "Etiquetas RFID",
            icon: "barcode",
            color: "amber",
            screen: "ListRfidTags",
            description: "Gestión de etiquetas RFID"
        },
        {
            title: "Movimientos",
            icon: "swap-vertical",
            color: "orange",
            screen: "ListDocumentMovements",
            description: "Movimientos de documentos"
        },
        {
            title: "Tarjetas RFID",
            icon: "card",
            color: "red",
            screen: "ListRfidCard",
            description: "Gestión de tarjetas RFID"
        },
        {
            title: "Estadísticas",
            icon: "stats-chart",
                    ...
                    <SimpleGrid columns={2} space={4} mb={5}>
                        {managementOptions.map((option, index) => (
                            <Button
                                ...
                                alignItems="center"
                            >
                                <Icon as={Ionicons} minWidth={110} name={option.icon} size={8} textAlign="center"
                                      color={`${option.color}.500`} mb={2}/>
