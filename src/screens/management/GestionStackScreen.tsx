...
const GestionStackScreen = () => {
    ...
    const managementOptions = [
        ...
        { title: t('management.administrators'), icon: "person-add", color: "indigo", screen: "ListAdministrator", description: t('management.admin_management') },
                ...
                <HStack justifyContent="space-between" alignItems="center">
                    ...
                    <HStack space={2}>
                        ...
                        <Badge colorScheme="primary" borderRadius="full" px={3} py={1}>
                            <Text color="white" fontSize="xs">{t('management.admin')}</Text>
                        </Badge>
                    </HStack>
                </HStack>
