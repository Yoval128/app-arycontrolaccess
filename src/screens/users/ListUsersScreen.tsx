...
const ListUsersScreen = () => {
    ...
    const textNumbers = useColorModeValue("white", "red");
        ...
        <NativeBaseProvider theme={customTheme}>
            <ScrollView>
                <Box safeArea p={5} flex={1}>
                    {/* Header */}
                    <Header title={t('listUsers.userManagement')} iconName="people"/>
                    ...
                    <HStack mb={2} space={4} alignItems="center" bg={cardBg} p={3} borderRadius="md">
                        ...
                        >
                            {user.role === 'administrador' && (
                                <>
                                    <Menu.Item
                                        onPress={() => navigation.navigate("UploadExcelUsers")}>{t('listUsers.menu.uploadFile')}</Menu.Item>
                                    <Menu.Item
                                        onPress={() => navigation.navigate("ExportPDFUser")}>{t('listUsers.menu.export')}</Menu.Item>
                                </>
                            )}
                            {user.role === 'empleado' && (
                                <>
                    ...
                    <HStack justifyContent="center" space={3} mt={4}>
                        ...
                        <Text color={"gray.500"}>{currentPage} de {totalPages}</Text>
